    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="jenis" id="jenis" value="<?= $data['jenis_barang']; ?>" required>
            </div>

            <div class="form-group">
                <label for="nama">Nama Barang:</label>
                <input type="text" name="nama" id="nama" value="<?= $data['nama_barang']; ?>" required>
            </div>

            <div class="form-group">
                <label for="harga">Harga Barang:</label>
                <input type="number" name="harga" id="harga" value="<?= $data['harga_barang']; ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="idsatuan" id="idsatuan" required>
                    <?php foreach ($satuan as $s): ?>
                      <option value="<?= $s['nomor_satuan']; ?>" <?= $s['nama_satuan'] == $data['nama_satuan'] ? 'selected' : ''; ?>>
                        <?= $s['nama_satuan']; ?>
                      </option>
                    <?php endforeach; ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="idvendor" id="idvendor" required>
                    <?php foreach ($vendor as $v): ?>
                      <option value="<?= $v['nomor_vendor']; ?>" <?= $v['nama_vendor'] == $data['nama_vendor'] ? 'selected' : ''; ?>>
                        <?= $v['nama_vendor']; ?>
                      </option>
                    <?php endforeach; ?>
                </select>
