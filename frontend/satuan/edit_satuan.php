...
<body>
    ...
    <div class="container">
        <div class="button-group">
            <a href="satuan.php" class="btn-kembali">← Kembali</a>
        </div>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="nama_satuan" id="nama_satuan" value="<?php echo htmlspecialchars($current_satuan['nama_satuan']); ?>" required>
            </div>
