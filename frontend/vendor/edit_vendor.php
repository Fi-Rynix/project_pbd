    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="nama_vendor" id="nama_vendor" value="<?php echo htmlspecialchars($current_vendor['nama_vendor']); ?>" required>
            </div>

            <div class="form-group">
                <label>Badan Hukum:</label>
                <div class="checkbox-group">
                    <input type="checkbox" name="badan_hukum" id="badan_hukum" value="Y" <?php echo $current_vendor['badan_hukum'] === 'Y' ? 'checked' : ''; ?>>
