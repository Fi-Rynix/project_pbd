  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="button-group">
        <a href="tambah_vendor.php" class="btn">+ Tambah Vendor</a>
      </div>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                  <a href="edit_vendor.php?idvendor=<?php echo $row['nomor_vendor']; ?>" class="link-btn">Edit</a>
                  <?php if($row['status_vendor'] == 1) { ?>
                      <a href="hapus_vendor.php?idvendor=<?php echo $row['nomor_vendor']; ?>" class="link-btn delete" onclick="return confirm('Yakin ingin hapus?')">Hapus</a>
                  <?php } ?>
              </td>
            </tr>
            <?php } ?>
